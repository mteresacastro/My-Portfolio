        ...
        <section className="mainProjects" id="mainProjects">
            ...
            <div className="mainProject__div">
                <article className="mainProjects__art">
                    <div className="mainProjects__art--img-container">
                        <img className="mainProjects__art--img" src={school} alt="" />
                        <div className="mainProjects__art--div">
                            ...
                            <ul className="mainProjects__art--div-ul">
                                <li><img className="div__ul--li" src="../src/images/html-48.png" alt="logo html" /></li>
                                <li><img className="div__ul--li" src="../src/images/css-48.png" alt="logo css" /></li>
                                <li><img className="div__ul--li" src="../src/images/sass-48.png" alt="logo sass" /></li>
                                <li><img className="div__ul--li" src="" alt="" /></li>
                            </ul>
                        </div>
                    </div>
                </article>
